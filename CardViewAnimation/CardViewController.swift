...
class CardViewController: UIViewController {
    ...
    private let handleArea: UIView = {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = UIColor(red: 57.0 / 255.0, green: 62.0 / 255.0, blue: 78.0 / 255.0, alpha: 1)
        return view
    }()
    ...
    private func setupClosedTransform() {
        let visibleHeight = view.frame.size.height - Constants.shared.preferredCardViewBottomInset
    ...
    private func setupUI() {
        ...
        if let contentView = contentView {
            ...
            contentView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -Constants.shared.preferredCardViewBottomInset).isActive = true
        }
    ...
    private func startAnimationIfNeeded() {
        ...
        animator = UIViewPropertyAnimator(duration: 0.65, dampingRatio: 0.72) {
            if self.isOpen {
